...
export default function BMSFooter() {
  return (
    <footer className="border-t" style={{ background: '#0F172A', borderColor: 'rgba(59,130,246,0.12)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="col-span-2 lg:col-span-1 space-y-4">
            ...
            <p className="text-sm leading-relaxed max-w-xs" style={{ color: '#9CA3AF' }}>
              Kochi&apos;s leading BMS &amp; smart building training institute. Real skills. Real certifications. Real careers.
            </p>
          ...
          {/* Quick links */}
          <div>
            <p className="text-xs font-bold uppercase tracking-widest mb-4" style={{ color: '#3B82F6' }}>
              Quick Links
            </p>
              ...
              {[
                ...
                <li key={href}>
                  <a href={href} className="flex items-center gap-2 text-sm transition-colors" style={{ color: '#9CA3AF' }}>
                    <Icon icon="mdi:chevron-right" className="w-3.5 h-3.5" style={{ color: 'rgba(59,130,246,0.5)' }} aria-hidden="true" />
                    {label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-3 text-sm" style={{ color: '#9CA3AF' }}>
              <p className="flex items-start gap-2">
                <Icon icon="mdi:map-marker-outline" className="w-4 h-4 shrink-0 mt-0.5" style={{ color: '#3B82F6' }} aria-hidden="true" />
                2nd Floor, Kaloor Bus Stand Complex, Cochin
              </p>
              <a href="tel:+919958873874" className="flex items-center gap-2 transition-colors hover:text-blue-400">
                <Icon icon="mdi:phone-outline" className="w-4 h-4" style={{ color: '#3B82F6' }} aria-hidden="true" />
                +91 99588 73874
              </a>
              <a href="tel:+919656227714" className="flex items-center gap-2 transition-colors hover:text-blue-400">
                <Icon icon="mdi:phone-outline" className="w-4 h-4" style={{ color: '#3B82F6' }} aria-hidden="true" />
                +91 96562 27714
              </a>
        ...
        >
          ...
          <p style={{ color: 'rgba(59,130,246,0.4)' }}>Skills &gt; Degrees.</p>
        </div>
      </div>
    </footer>
  )
