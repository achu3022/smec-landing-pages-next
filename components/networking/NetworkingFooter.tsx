...
export default function NetworkingFooter() {
  return (
    <footer className="border-t" style={{ background: '#000000', borderColor: 'rgba(34,197,94,0.12)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="col-span-2 lg:col-span-1 space-y-4">
            ...
            <p className="text-sm leading-relaxed max-w-xs" style={{ color: '#9CA3AF' }}>
              Kochi&apos;s leading networking &amp; cyber security training institute. Real skills. Real certifications. Real careers.
            </p>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border text-xs font-bold"
              ...
              Networking &amp; Cyber Security Courses
            </div>
          </div>
              ...
              {[
                ...
                <li key={href}>
                  <a href={href} className="flex items-center gap-2 text-sm transition-colors" style={{ color: '#9CA3AF' }}
                    ...
                    <Icon icon="mdi:chevron-right" className="w-3.5 h-3.5" style={{ color: 'rgba(34,197,94,0.4)' }} aria-hidden="true" />
                    {label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-3 text-sm" style={{ color: '#9CA3AF' }}>
              ...
              <a href="tel:+919958873874" className="flex items-center gap-2 transition-colors hover:text-green-400">
                <Icon icon="mdi:phone-outline" className="w-4 h-4" style={{ color: '#22C55E' }} aria-hidden="true" />
                +91 99588 73874
              </a>
              <a href="tel:+919656227714" className="flex items-center gap-2 transition-colors hover:text-green-400">
                <Icon icon="mdi:phone-outline" className="w-4 h-4" style={{ color: '#22C55E' }} aria-hidden="true" />
                +91 96562 27714
              </a>
        ...
        <div className="mt-10 pt-6 border-t flex flex-col sm:flex-row items-center justify-between gap-3 text-xs"
          ...
          <p style={{ color: 'rgba(34,197,94,0.4)' }}>Hack. Defend. Own the Network.</p>
        </div>
      </div>
    </footer>
  )
