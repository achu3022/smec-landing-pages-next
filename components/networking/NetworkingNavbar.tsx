...
export default function NetworkingNavbar() {
  return (
    <nav
      ...
      style={{ background: 'rgba(0,0,0,0.97)', borderColor: 'rgba(34,197,94,0.18)' }}
    >
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <a href={WA} target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-1.5 px-5 py-2 rounded-xl text-sm font-extrabold transition-colors net-glow-pulse"
          ...
          <div className="md:hidden">
            <a href={WA} target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-1 px-3 py-2 rounded-lg text-xs font-extrabold net-glow-pulse"
              style={{ background: '#22C55E', color: '#000' }}
            >
