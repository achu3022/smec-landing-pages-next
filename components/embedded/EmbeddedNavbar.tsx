...
export default function EmbeddedNavbar() {
  return (
    <nav
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <div className="relative group">
              ...
              <div
                ...
                style={{ background: 'rgba(10,10,15,0.98)', borderColor: 'rgba(139,92,246,0.2)' }}
              >
                <div className="px-3 py-2 border-b" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
                  <p className="text-[10px] font-bold uppercase tracking-widest" style={{ color: 'rgba(139,92,246,0.5)' }}>Other Courses</p>
                </div>
                {[
                  ...
                  <a key={href} href={href}
                    ...
                    style={{ color: '#9CA3AF' }}
                    onMouseEnter={(e) => { e.currentTarget.style.color = '#fff'; e.currentTarget.style.background = 'rgba(139,92,246,0.08)' }}
                    onMouseLeave={(e) => { e.currentTarget.style.color = '#9CA3AF'; e.currentTarget.style.background = 'transparent' }}
                  >
                    <Icon icon={icon} className="w-4 h-4 shrink-0" style={{ color: 'rgba(139,92,246,0.6)' }} aria-hidden="true" />
                    {label}
                  </a>
                ))}
              </div>
