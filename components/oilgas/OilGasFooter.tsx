...
export default function OilGasFooter() {
  return (
    <footer className="border-t" style={{ background: '#0B0B0B', borderColor: 'rgba(212,175,55,0.12)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="col-span-2 lg:col-span-1 space-y-4">
            ...
            <p className="text-sm leading-relaxed max-w-xs" style={{ color: '#9CA3AF' }}>
              Kochi&apos;s leading oil &amp; gas training institute. Real skills. Real certifications. Real careers.
            </p>
            ...
            >
              <span className="w-1.5 h-1.5 rounded-full animate-pulse" style={{ background: '#D4AF37' }} aria-hidden="true" />
              Oil &amp; Gas Courses
            </div>
          </div>
              ...
              {[
                ...
                <li key={href}>
                  <a href={href} className="flex items-center gap-2 text-sm transition-colors" style={{ color: '#9CA3AF' }}>
                    <Icon icon="mdi:chevron-right" className="w-3.5 h-3.5" style={{ color: 'rgba(212,175,55,0.5)' }} aria-hidden="true" />
                    {label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-3 text-sm" style={{ color: '#9CA3AF' }}>
              <p className="flex items-start gap-2">
                <Icon icon="mdi:map-marker-outline" className="w-4 h-4 shrink-0 mt-0.5" style={{ color: '#D4AF37' }} aria-hidden="true" />
              ...
              <a href="tel:+919958873874" className="flex items-center gap-2 transition-colors hover:text-yellow-400">
                <Icon icon="mdi:phone-outline" className="w-4 h-4" style={{ color: '#D4AF37' }} aria-hidden="true" />
                +91 99588 73874
              </a>
        ...
        >
          ...
          <p style={{ color: 'rgba(212,175,55,0.4)' }}>Skills &gt; Degrees.</p>
        </div>
      </div>
    </footer>
  )
